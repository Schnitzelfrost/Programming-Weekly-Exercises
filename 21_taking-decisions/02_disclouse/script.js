...
refundHeader.addEventListener("pointerdown", ___);
...
function supportDisclosure() {
  ...
  if (___) {
    ...
    // We want to hide the chevron that points down (v)
    ___(supportChevronDown);

    // And show the one that points up (^)
    ___(supportChevronUp);
