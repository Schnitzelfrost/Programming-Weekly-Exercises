...
/**
 * Return a button that clears the input.
 * @returns Element
 */
function makeClearButton() {
    ...
    clearElement.addEventListener("pointerover", function (event) {
        globalInput = "";
...
/**
 * Return a button that acts as an input key.
 * @param {string} key 
 * @returns Element
 */
function makeKey(key) {
    ...
    keyElement.addEventListener("pointerover", function (event) {
        globalInput += key;
        keypadDisplay.innerHTML = globalInput;
    });
